...
const CG_RACES = [
  ...
  { id:'primordial',name:'Primordial Being',emoji:'🌌', weight:3.5,  subKey:'elementalWheel', trait:'Tournament/championship win: receive Elemental Wheel (replaces PVP Reward).' },
